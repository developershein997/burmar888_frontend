  ...
  const handleLaunchGame = async () => {
    ...
    try {
      const response = await fetch(
        'https://moonstar543.pro/api/shan-launch-game',
        {
          method: 'POST',
          headers: {
          ...
          body: JSON.stringify({
            member_account: user?.member_account || user?.user_name,
            operator_code,
          }),
        }
      );
            ...
            <>
              <div className='mb-4 grid grid-cols-1 gap-2 text-center text-sm text-gray-200'>
                ...
                <div>
                  ...
                  <span className='font-mono'>{operator_code}</span>
                </div>
              </div>
              {error && (
